...
public class LogConditionalObjectiveFunction
{
	...
	LogPrior prior = new LogPrior(10.0);
	List<Datum> data;
	final Index featureIndex = new Index();
	final Index labelIndex = new Index();
	...
	public double valueAt(double[] x)
	{
		...
		arraycopy(x, 0, prevX, 0, x.length);
